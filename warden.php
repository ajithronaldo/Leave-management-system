<?php 
    ...
    if($_SESSION['sess_userrole'] != "Warden"){
        header('Location: index.php?err=2');
    }
?>

<?php
  if($_SESSION['sess_username'] != 'Boys Hostel'){
    $gender = 'Female';
  }else{
    $gender = 'Male';
  }
...
<head>
  ...
  <body>
    ...
    <div class="container-fluid">
      ...
      <button class="tablink" onclick="openPage('upcoming_leave', this)" >Upcoming Leave</button>
      ...
      <div id="current_leave" class="tabcontent">
        ...
        <?php
          ...
          $getStudentLeaveQuery = 'SELECT * FROM studentleave where FromDate = :dat and Gender = :gen and student_type = "Hosteller"  and Principal_Approval = "Approved" ORDER BY AppliedOn';
          $getStudentLeaveProcess = $dbh->prepare($getStudentLeaveQuery);
          $getStudentLeaveProcess->execute(array(':dat' => date("Y-m-d"),':gen' => $gender));
      ...
      <div id="upcoming_leave" class="tabcontent">
        <center><h3>Upcoming Student Leave Requests</h3></center>
        <?php
          require "config/Connection.php";
      ...
      <div id="history" class="tabcontent">
        <center><h3>Previous Student Leave Requests</h3></center>
        <?php
          require "config/Connection.php";
